...
function game() {
   ...
   sceneEl.appendChild(score);
     ...
     for(var i=0; i<30; i++)
     {
       ...
       var rand_pos = Math.random() * (2-0) + 0;
       rand_pos = Math.round(rand_pos);
      ...
      // CUBI + ANIMAZIONE + EVENTI
       ...
       entityEl[i].setAttribute('animation', 'property: position; to: '+positions[rand_pos]+'; dur: 100000; easing: linear');
